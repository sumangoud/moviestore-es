...
/**
 * This class is used as a Json utility. The base functionality comes from the
 * Gson<br>
 * package from Google. It is made generic due to the fact that many clients may
 * use<br>
